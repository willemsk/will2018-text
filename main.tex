...
Francescini-2013,Jain-2018} or proteins\cite{Restrepo-Perez-2018,Talaga-2009,Rodriguez-Larrea-2013,
...
Bhattacharya-2011,Zhang-2014,DiMarino-2015,Belkin-2016} Brownian dynamics (BD),\cite{Schirmer-1999,
Noskov-2004,Millar-2008,Egwolf-2010,DeBiase-2015,Pederson-2015} and the coupled Poisson, Nernst--Planck and
Navier--Stokes (PNP-NS) equations\cite{Simakov-2010,Pederson-2015,Hsu-2017b,Gillespie-2002}. The latter
equations are of particular interest due to their low computational cost, analytical tractability and directly
accessible the steady-state property distributions. However, due to the breakdown of the continuum assumption
below $\approx5$~nm and the neglect of inter-molecular interactions, great care must be taken when using the
PNP-NS equations for ion channels and small
nanopores.\cite{Corry-2000,Bazant-2009,Daiguji-2010,Muthukumar-2014} To overcome these limitations, a
multitude of improvements have been made over the years to account for the finite size of the
ions\cite{Eisenberg-1996,Borukhov-1997,Gillespie-2002,Kilic-2007,Lu-2011,Chaudhry-2014}, positional-dependent
ionic mobilities\cite{Simakov-2010, Pederson-2014} and fluid viscosities,\cite{Vu-2016} and
concentration-dependent ion mobilities\cite{Baldessari-2008-2,Burger-2012} and relative
permittivities\cite{Li-2014}.
...
Nanopores are generally operated in the `resistive-pulse' mode, where a constant voltage is applied across two
electrolyte reservoirs connected solely by a nanopore. The majority of the voltage change occurs near and
within the nanopore, resulting in strong electrical field ($10^7$--$10^8$~mV~nm$^{-1}$) at these locations
that drives ions and water molecules through the pore. This ionic flux is measured as a steady current signal,
which depends strongly on the geometry of the pore (size, shape and charge) and the environment in which it
resides (salt concentration, temperature, etc.). Hence, the interaction with, or translocation through, the
nanopore of a molecule of comparable dimensions is often reflected in the ionic current as a temporal
variation. The magnitude, duration and noise levels of such events depend on the size, shape and charge of
both the molecule and nanopore and can serve as a unique molecular `fingerprint'. The frequency of events can
be linked to the bulk concentration of the molecule, but also depends on the transport mechanism with which it
is to interrogated molecule, but also of the nanopore itself. For many nanopores, the movement of molecules
towards or away from the nanopore is not only governed by a coulombic (`electrophoretic') force, but also
includes an hydrodynamic (`electro-osmostic') component. This so-called electro-osmotic flow arises from the
viscous drag exerted by the movement of the electrical double layer along the interior walls of a charged
nanopore.\cite{Wong-2007,Mao-2014,Haywood-2014,Laohakunakorn-2015}
...
used in experimental studies of both proteins
\cite{Soskine-2013,VanMeervelt-2014,Soskine-Biesemans-2015,Biesemans-Soskine-2015,Wloka-2017,VanMeervelt-2017,
Galenkamp-2018} and DNA,
...
properties and to further our general understanding of the pore. To this end, we implemented a modified
version of the Poisson-Nernst-Planck-Navier-Stokes (PNP-NS) equations and solved it for a 2D-axisymmetric
continuum model of ClyA-AS. Our modifications attempt to empirically extend the validity of the PNP-NS
equations 1) at the nanoscale and 2) beyond infinite dilution. For the former, we  implemented spatially
dependent ion transport coefficients,\cite{Makarov-1998, Simakov-2010} and an solvent
viscosity\cite{Pronk-2014,Hsu-2017}, which respectively decrease and increase significantly in close proximity
to the nanopore wall. For the latter, we took for the finite size of the ions into account by inclusion of a
steric flux term,\cite{Lu-2011} and implemented self-consistent, empirical concentration dependencies of the
ionic diffusion coefficients and mobilities,\cite{Baldessari-2008-1} and the solvent density,\cite{} viscosity
and relative permittivity.\cite{Gavish-2016}
...
of the ion transport through ClyA in terms of conductance, rectification and selectivity. The values of the
former two parameters were also measured experimentally and employed as a benchmark to gauge the accuracy of
our model. This is followed by a detailed description of several parameters that are of great interest, but
cannot be readily determined experimentally, namely the concentration of cations and anions inside the pore,
the ionic charge density inside the pore, the distribution of the electrostatic potential and the properties
of the electro-osmotic flow. While this work solely describes the ClyA nanopore, the lessons learned form the
modeling can be readily transferred to other types of nanopores.
