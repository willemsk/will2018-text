...
reservoir boundary $S$. $\faraday$ is the Faraday constant (\SI{96485}{\coulomb\per\mole}) and $\normvec$ is 
...
\subsection{Ion charge density distribution}\label{sect:ion_charge_density}
