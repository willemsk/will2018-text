...
biological nanopore system (\SIrange{100K}{1M}{atoms}) 100s of nanoseconds still necessitates the use of
supercomputers.\cite{Aksimentiev-2004,Bhattacharya-2011} The PNP(-NS) equations, on the other hand, are of
...
investigated concentration range, the IVs from the ePNP-NS model closely corresponded to the measured values
...
largest at lower salt concentrations, with smaller and larger currents at negative and positive bias
voltages, respectively. Their cause is likely to be found in the under- and overestimation of the cation
concentration at these respective voltages.\todo{ref} It is also possible that the mobility we use, which is parameterized using electroneutral `bulk' values for unconfined ions, begins to break down under these
