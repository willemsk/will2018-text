...
the case of a binary electrolyte such as \ce{NaCl}, a pore is said the be cation selective when the 
contribution of \ce{Na+} to the overall current is larger than that of \ce{Cl-}, and anion selective if the 
