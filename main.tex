...
continuum simulations, this can be achieved with the use pf positional-dependent ion diffusion coefficients.
...
corrections make use of using empirical functions that were fitted to experimental data
...
full atom model of ClyA-AS. The \emph{ionic} charge density in the fluid is given by
%
...
it to model the transport of ions and water through the biological nanopore ClyA. Our ePNP-NS equations take
