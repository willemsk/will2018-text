...
\keywords{biological nanopore; single molecule; simulation; cytolysin A}
...
of the steady-state Poison-Nernst-Planck-Navier-Stokes (ePNP-NS) equations that includes self-consistent 
concentration- and positional-dependencies for all coefficients. In this study we shown that our model, in 
conjunction with the ePNP-NS equations, faithfully reproduces the experimentally observed ionic currents over 
a wide range of ionic strengths and applied voltages. We further describe the influence of these two 
parameters on various quantities of interest, including the ion concentrations inside the pore, the shape of 
the electrostatic potential landscape and the magnitude and direction of the electro-osmotic flow. 
\todo{extend}
\end{abstract}
\end{@twocolumnfalse}
]
...
pore\cite{Bhattacharya-2011}\todo{ref}). The distribution at physiological salt concentrations 
