...
constriction ($\Delta E_{\text{B},i}$, \cref{fig:potential_trans_energy_barrier}).
...
they face the second, more significant energy barrier (\cref{fig:potential_trans_energy_barrier}, blue 
...
reduction of their electrostatic energy, as the bulk of the voltage drop occurs after the \trans\ 
constriction.
...
barrier (\cref{fig:potential_trans_energy_barrier}, red curves), which reduces the nanopore's ability to 
...
large energy barrier at the constriction (\cref{fig:potential_trans_energy_barrier}, red curves). This 
...
typically observed for electro-osmotically driven flows \todo{ref}. Interestignly, at high salt 
