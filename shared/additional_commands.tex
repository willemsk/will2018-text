...
\DeclareSIUnit{\kBTe}{
  \ensuremath{\textit{k}_{\textrm{B}}}
  \textit{T}
  \per \ensuremath{\textit{e}_{\textrm{c}}}
}
...
\newcommand{\kTe}{\kT \echarge^{-1}}
\newcommand{\revpot}{V_{\text{r}}}


\newcommand{\pavi}{\pav{\ci/\cbulk}{p}}
\newcommand{\pavNa}{\pav{\cNa/\cbulk}{p}}
\newcommand{\pavCl}{\pav{\cCl/\cbulk}{p}}
