...
\renewcommand{\r}{\vec{r}} % positional vector
...
\newcommand{\Vbias}{\varpotential_{\rm bias}}% applied bias
...
\newcommand{\dconc}{\concentration_{\rm d}}		% Dimensionless concentration
\newcommand{\dwall}{\walldistance_{\rm d}}		% Dimensionless wall distance
