...
\end{align}
%
where $\viscosity^0$ and $\density^0$ are the values at infinite dilution, \ie{}~
pure water, $\viscosity^c(\avionconc)$, $\density^c(\avionconc)$ and
...
\SIrange{-150}{+150}{\mV} and at \SIlist{0.05;0.15;0.5;1;3}{\Molar} \ce{NaCl}) and compared them directly to the values obtained from
steady-state simulations using both the classical PNP-NS and the new ePNP-NS
equations (\cref{fig:current-voltage_curves}, cf.~\nameref{sec:methods} for
