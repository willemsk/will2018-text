\begin{figure*}[!htb]
  ...
  \begin{minipage}[h]{8cm}
    ...
    \begin{subfigure}[t]{4cm}
      ...
      \includegraphics[scale=1]{../figures/conductance/conductance_loglog_exp_epnp}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{4cm}
      ...
      \includegraphics[scale=1]{../figures/conductance/transport_number_vs_concentration_epnp}
    \end{subfigure}
  \end{minipage}
\end{minipage}
